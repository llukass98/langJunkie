...
public class BAmoozDictionaryTest {
	...
	static Document doc;
	static HashMap<String, Serializable> result;
	static String word;

	@BeforeClass
	public static void generalSetUp() throws Exception {
		notMockedDictionary = new BAmoozDictionary();
	...
	public void examplesValueShouldBeAnEmptyArray() {
		assertThat((ArrayList<String>) result.get("examples"),
				equalTo(new ArrayList<String>()));
	}

	@Test
	public void synonymsValueShouldBeAnEmptyArray() {
		assertThat((ArrayList<String>) result.get("synonyms"),
				equalTo(new ArrayList<String>()));
	}
